"""Two assets with two Bergomi volatility factors each, calibrated target risk and cross Gamma."""
import math
...
# Driver order: W_A, W_B, V_A1, V_A2, V_B1, V_B2. The complete own-asset
# 3x3 blocks must match the configuration used in each marginal calibration.
...
for name, product in products.items():
    ...
    assert plan.random_factor_count == 6
    assert [c.volatility_factor_count for c in plan.lsv_calibrations] == [2, 2]
