...
use crate::mc::{EngineConfig, LsmConfig};
use crate::models::ModelSpec;
use crate::product::{AsianObservationValue, ProductSpec};
use crate::risk::RiskRequest;
...
mod tests {
    ...
    use crate::market::{EquityForward, EquityMarket, LogLinearDiscountCurve};
    use crate::mc::{
        CpqrConfig, LsmStateVariable, PolynomialBasisSpec, PseudoMcConfig, VarianceReduction,
    };
    use crate::models::{Black76Spec, BlackScholesSpec};
    use crate::product::{
