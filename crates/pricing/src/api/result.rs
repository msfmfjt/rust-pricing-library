...
use crate::core::{FiniteF64, NonNegativeF64, PositiveF64, SchemaVersion};
use crate::risk::{VegaKtBucketUnit, VegaKtReport};
    ...
    fn try_from(value: &VegaKtReport) -> Result<Self, Self::Error> {
        ...
        Self::new(
            ...
            match value.covariance_layout() {
                crate::risk::VegaKtCovarianceLayout::PriceAndBucketVarianceOnly => {
                    VegaKtResultCovarianceLayout::PriceAndBucketVarianceOnly
                }
                crate::risk::VegaKtCovarianceLayout::FullBucketMatrixRowMajor => {
