...
use crate::core::{CoreError, CurrencyId, Date, UnderlyingId};
use crate::engine::aad::AadConfigError;
...
use crate::product::GraphError;
use crate::risk::RiskConfigError;
...
impl From<crate::mc::lsv::LsvError> for MonteCarloError {
    fn from(error: crate::mc::lsv::LsvError) -> Self {
        Self::Lsv(error)
    }
}

impl From<crate::mc::hull_white::HullWhiteMcError> for MonteCarloError {
    fn from(error: crate::mc::hull_white::HullWhiteMcError) -> Self {
        Self::HullWhite(error)
    }
}
impl From<crate::models::HullWhiteError> for MonteCarloError {
    fn from(error: crate::models::HullWhiteError) -> Self {
