...
impl LsmConfig {
    ...
    #[must_use]
    pub const fn training_random_domain(&self) -> crate::mc::RandomDomain {
        match self.training_engine {
            EngineConfig::PseudoMonteCarlo(_) => crate::mc::RandomDomain::LsmTrain,
            EngineConfig::RandomizedQuasiMonteCarlo(_) => crate::mc::RandomDomain::RqmcScramble,
        }
    }
...
pub struct ExercisePolicyTrainingMetadata {
    ...
    random_domain: crate::mc::RandomDomain,
}
...
impl ExercisePolicyTrainingMetadata {
    ...
    pub fn new_with_random_domain(
        ...
        if !matches!(
            random_domain,
            crate::mc::RandomDomain::LsmTrain | crate::mc::RandomDomain::RqmcScramble
        ) {
    ...
    #[must_use]
    pub const fn random_domain(self) -> crate::mc::RandomDomain {
        self.random_domain
    }
}
...
fn hash_variance_reduction(hasher: &mut blake3::Hasher, value: crate::mc::VarianceReduction) {
    hasher.update(&[
