...
use crate::core::{EventId, PathIndex};
use crate::market::{
...
use crate::mc::{
    BrownianBridgeError, BrownianBridgePlan, Philox4x32, RandomCoordinate, RandomDomain,
};
...
impl From<crate::market::MarketError> for LocalVolError {
    fn from(value: crate::market::MarketError) -> Self {
        Self::Market(value)
    }
}
...
mod tests {
    use super::*;
    use crate::core::{EventId, PositiveF64, UnderlyingId};
    use crate::market::{DividendEvent, DividendQuote};
