...
pub use lsm::{
    ...
    ExercisePolicyTrainingOutcome, ExerciseRegressionDiagnostics, FeatureScaling, LSM_BASIS_ABI,
    LSM_POLICY_ABI, LSM_REGRESSION_ABI, LsmNumericalError, LsmWarning, PolynomialBasisSpec,
