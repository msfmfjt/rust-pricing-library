...
|---|---|
| Local Vega calculated by Monte Carlo and AD | Covered by Local Volatility reverse tests and risk orchestration tests; public Local Volatility evaluation currently returns Price/Delta/Gamma for MC/RQMC; public Local Vega/VegaKT output and full same-platform replay fixture still pending |
...
- Extend the public Local Volatility entry point from Price/Delta/Gamma
  MC/RQMC to Local Vega and VegaKT output.
