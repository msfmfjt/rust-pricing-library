...
def verify_stub_static_shape(tree: ast.Module) -> None:
    ...
    expected_signature_shapes = {
        ...
        ('StochasticDividendPlan', 'compile_bergomi_lsv'): {'positional': ['request'], 'positional_defaults': {}, 'keyword_only': ['mean_reversion', 'vol_of_vol', 'correlation', 'dividend_mean_reversion', 'equity_linkage', 'dividend_volatility', 'equity_dividend_correlation', 'dividend_volatility_correlation', 'particle_count', 'calibration_seed', 'log_bandwidth', 'minimum_effective_samples', 'retain_reverse_trace', 'maximum_step', 'worker_threads', 'reduction_block_size'], 'required_keyword_only': ['mean_reversion', 'vol_of_vol', 'correlation', 'dividend_mean_reversion', 'equity_linkage', 'dividend_volatility', 'equity_dividend_correlation', 'dividend_volatility_correlation', 'particle_count', 'calibration_seed', 'log_bandwidth', 'minimum_effective_samples', 'retain_reverse_trace', 'maximum_step', 'worker_threads'], 'keyword_only_defaults': {'reduction_block_size': None}},
        ('StochasticDividendPlan', 'compile_bergomi_two_factor_lsv'): {'positional': ['request'], 'positional_defaults': {}, 'keyword_only': ['mean_reversions', 'vol_of_vol', 'mixing_weight', 'spot_correlations', 'factor_correlation', 'dividend_mean_reversion', 'equity_linkage', 'dividend_volatility', 'equity_dividend_correlation', 'dividend_volatility_correlations', 'particle_count', 'calibration_seed', 'log_bandwidth', 'minimum_effective_samples', 'retain_reverse_trace', 'maximum_step', 'worker_threads', 'reduction_block_size'], 'required_keyword_only': ['mean_reversions', 'vol_of_vol', 'mixing_weight', 'spot_correlations', 'factor_correlation', 'dividend_mean_reversion', 'equity_linkage', 'dividend_volatility', 'equity_dividend_correlation', 'dividend_volatility_correlations', 'particle_count', 'calibration_seed', 'log_bandwidth', 'minimum_effective_samples', 'retain_reverse_trace', 'maximum_step', 'worker_threads'], 'keyword_only_defaults': {'reduction_block_size': None}},
    ...
    expected_class_members = {
        ...
        'StochasticDividendPlan': {'evaluate_rough_aad', 'compile_rough_bergomi', 'compile_bergomi_lsv', 'compile_bergomi_two_factor_lsv', 'evaluate_gamma', 'evaluate_correlation_aad', 'evaluate_bergomi_aad', 'evaluate_aad', 'evaluate_local_variance_risk', 'compile_bergomi', 'compile_bergomi_two_factor', 'scheme', 'evaluate', 'plan_fingerprint', 'time_nodes', 'compile_bs', 'risky_spot', 'random_factor_count', 'lsv_time_nodes', 'lsv_log_moneyness_nodes', 'lsv_squared_leverage', 'lsv_initial_residual_equity'},
