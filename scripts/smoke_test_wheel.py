...
def verify_stub_static_shape(tree: ast.Module) -> None:
    ...
    expected_class_members = {
        ...
        'StochasticDividendPlan': {'evaluate_rough_aad', 'compile_rough_bergomi', 'compile_bergomi_lsv', 'compile_bergomi_two_factor_lsv', 'evaluate_gamma', 'evaluate_correlation_aad', 'evaluate_bergomi_aad', 'evaluate_aad', 'evaluate_local_variance_risk', 'evaluate_vega_kt', 'compile_bergomi', 'compile_bergomi_two_factor', 'scheme', 'evaluate', 'plan_fingerprint', 'time_nodes', 'compile_bs', 'risky_spot', 'random_factor_count', 'lsv_time_nodes', 'lsv_log_moneyness_nodes', 'lsv_squared_leverage', 'lsv_initial_residual_equity'},
