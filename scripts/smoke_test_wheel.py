...
def verify_stub_static_shape(tree: ast.Module) -> None:
    ...
    expected_top_level_names = {
        ...
        "LsmWarning",
        "LsmWarningKind",
        "ExerciseDecisionDiagnostics",
        "ExerciseDecisionKind",
        "ExerciseRegressionDiagnostics",
        "ExerciseStrategyRisk",
        "RandomDomain",
        "StoppingIndexRisk",
        "SmileDynamics",
        "ValidationError",
    ...
    expected_literals = {
        ...
        "LsmStateVariable": {"spot"},
        "ExerciseStrategyRisk": {"fixed_exercise_strategy"},
        "StoppingIndexRisk": {"frozen_stopping_indices"},
        "RandomDomain": {"valuation", "lsm_train", "rqmc_scramble", "diagnostics"},
        "LsmWarningKind": {
            "zero_itm_training_paths",
            "inactive_feature",
            "rank_excluded_basis_column",
        },
        "ExerciseDecisionKind": {"regression", "continue_all"},
        "RiskUnit": {
    ...
    expected_signature_shapes = {
        ...
        ("StochasticDividendHullWhitePlan", "evaluate_hull_white_aad"): {"positional": ["self"], "positional_defaults": {}, "keyword_only": [], "required_keyword_only": [], "keyword_only_defaults": {}},
        ("StochasticDividendHullWhitePlan", "evaluate_correlation_aad"): {"positional": ["self"], "positional_defaults": {}, "keyword_only": [], "required_keyword_only": [], "keyword_only_defaults": {}},
        ('StochasticDividendHullWhitePlan', 'evaluate_gamma'): {'positional': ['self'], 'positional_defaults': {}, 'keyword_only': ['gamma_absolute_bump', 'gamma_relative_bump'], 'required_keyword_only': [], 'keyword_only_defaults': {'gamma_absolute_bump': None, 'gamma_relative_bump': None}},
        ...
        ('StochasticDividendPlan', 'compile_bergomi_two_factor_lsv'): {'positional': ['request'], 'positional_defaults': {}, 'keyword_only': ['mean_reversions', 'vol_of_vol', 'mixing_weight', 'spot_correlations', 'factor_correlation', 'dividend_mean_reversion', 'equity_linkage', 'dividend_volatility', 'equity_dividend_correlation', 'dividend_volatility_correlations', 'particle_count', 'calibration_seed', 'log_bandwidth', 'minimum_effective_samples', 'maximum_step', 'worker_threads', 'reduction_block_size', 'retain_reverse_trace'], 'required_keyword_only': ['mean_reversions', 'vol_of_vol', 'mixing_weight', 'spot_correlations', 'factor_correlation', 'dividend_mean_reversion', 'equity_linkage', 'dividend_volatility', 'equity_dividend_correlation', 'dividend_volatility_correlations', 'particle_count', 'calibration_seed', 'log_bandwidth', 'minimum_effective_samples', 'maximum_step', 'worker_threads'], 'keyword_only_defaults': {'reduction_block_size': None, 'retain_reverse_trace': False}},
        ...
        ('StochasticDividendPlan', 'evaluate_lsv_market_risk'): {'positional': ['self'], 'positional_defaults': {}, 'keyword_only': [], 'required_keyword_only': [], 'keyword_only_defaults': {}},
        ('StochasticDividendPlan', 'evaluate_lsv_dividend_model_risk'): {'positional': ['self'], 'positional_defaults': {}, 'keyword_only': ['dividend_mean_reversion_bump', 'equity_linkage_bump', 'dividend_volatility_bump', 'equity_dividend_correlation_bump'], 'required_keyword_only': ['dividend_mean_reversion_bump', 'equity_linkage_bump', 'dividend_volatility_bump', 'equity_dividend_correlation_bump'], 'keyword_only_defaults': {}},
        ('StochasticDividendPlan', 'evaluate_lsv_bergomi_parameter_risk'): {'positional': ['self'], 'positional_defaults': {}, 'keyword_only': ['mean_reversion_bump', 'vol_of_vol_bump'], 'required_keyword_only': ['mean_reversion_bump', 'vol_of_vol_bump'], 'keyword_only_defaults': {}},
        ('StochasticDividendPlan', 'evaluate_lsv_rough_bergomi_parameter_risk'): {'positional': ['self'], 'positional_defaults': {}, 'keyword_only': ['hurst_bump', 'vol_of_vol_bump'], 'required_keyword_only': ['hurst_bump', 'vol_of_vol_bump'], 'keyword_only_defaults': {}},
        ('StochasticDividendPlan', 'evaluate_lsv_rough_bergomi_correlation_risk'): {'positional': ['self'], 'positional_defaults': {}, 'keyword_only': ['equity_volatility_correlation_bump', 'dividend_volatility_correlation_bump'], 'required_keyword_only': ['equity_volatility_correlation_bump', 'dividend_volatility_correlation_bump'], 'keyword_only_defaults': {}},
        ('StochasticDividendPlan', 'evaluate_lsv_correlation_risk'): {'positional': ['self'], 'positional_defaults': {}, 'keyword_only': ['equity_volatility_correlation_bump', 'dividend_volatility_correlation_bump'], 'required_keyword_only': ['equity_volatility_correlation_bump', 'dividend_volatility_correlation_bump'], 'keyword_only_defaults': {}},
        ('StochasticDividendPlan', 'evaluate_lsv_bergomi_two_factor_parameter_risk'): {'positional': ['self'], 'positional_defaults': {}, 'keyword_only': ['mean_reversion_bumps', 'vol_of_vol_bump', 'mixing_weight_bump'], 'required_keyword_only': ['mean_reversion_bumps', 'vol_of_vol_bump', 'mixing_weight_bump'], 'keyword_only_defaults': {}},
        ('StochasticDividendPlan', 'evaluate_lsv_bergomi_two_factor_correlation_risk'): {'positional': ['self'], 'positional_defaults': {}, 'keyword_only': ['spot_volatility_correlation_bumps', 'factor_correlation_bump', 'dividend_volatility_correlation_bumps'], 'required_keyword_only': ['spot_volatility_correlation_bumps', 'factor_correlation_bump', 'dividend_volatility_correlation_bumps'], 'keyword_only_defaults': {}},
        ('StochasticDividendPlan', 'evaluate_vega_kt'): {'positional': ['self'], 'positional_defaults': {}, 'keyword_only': [], 'required_keyword_only': [], 'keyword_only_defaults': {}},
        ...
        ('StochasticDividendPlan', 'evaluate_rough_aad'): {'positional': ['self'], 'positional_defaults': {}, 'keyword_only': [], 'required_keyword_only': [], 'keyword_only_defaults': {}},
        ('StochasticDividendPlan', 'evaluate_correlation_aad'): {'positional': ['self'], 'positional_defaults': {}, 'keyword_only': [], 'required_keyword_only': [], 'keyword_only_defaults': {}},
        ...
        ('CorrelationSchedule', '__init__'): {'positional': ['self', 'underlying_ids', 'effective_dates', 'matrices'],
         ...
         'keyword_only': ['symmetry_abs_tol',
                          ...
                          'zero_pivot_abs_tol',
                          'zero_pivot_rel_tol'],
         'required_keyword_only': ['symmetry_abs_tol',
                                   'diagonal_abs_tol',
                                   'psd_abs_tol',
                                   'psd_rel_tol',
                                   'zero_pivot_abs_tol',
                                   'zero_pivot_rel_tol'],
         'keyword_only_defaults': {}},
        ('AutocallObservation', '__init__'): {'positional': ['self', 'date', 'payment_date'],
         'positional_defaults': {},
         'keyword_only': ['coupon_amount', 'coupon_level', 'call_level', 'call_coupon_amount'],
         'required_keyword_only': ['coupon_amount', 'coupon_level'],
         'keyword_only_defaults': {'call_level': None, 'call_coupon_amount': 0.0}},
        ('MultiAssetProduct', 'basket'): {'positional': ['underlying_ids', 'weights', 'scales', 'side', 'strike', 'expiry', 'payment_date'],
         'positional_defaults': {},
         'keyword_only': ['currency_id', 'notional', 'smoothing_half_width'],
         'required_keyword_only': [],
         'keyword_only_defaults': {'currency_id': 1, 'notional': 1.0, 'smoothing_half_width': None}},
        ('MultiAssetProduct', 'worst_of'): {'positional': ['underlying_ids', 'reference_levels', 'side', 'strike', 'expiry', 'payment_date'],
         'positional_defaults': {},
         'keyword_only': ['currency_id', 'notional', 'smoothing_half_width'],
         'required_keyword_only': [],
         'keyword_only_defaults': {'currency_id': 1, 'notional': 1.0, 'smoothing_half_width': None}},
        ('MultiAssetProduct', 'autocallable'): {'positional': ['underlying_ids',
                        'reference_levels',
                        'observations',
                        'maturity',
                        'maturity_payment'],
         'positional_defaults': {},
         'keyword_only': ['notional',
                          'final_barrier',
                          'memory',
                          'on_autocall',
                          'on_maturity',
         ...
         'required_keyword_only': ['notional', 'final_barrier', 'memory', 'on_autocall', 'on_maturity'],
        ...
        ('MultiAssetPlan', 'compile'): {'positional': ['valuation_date', 'product', 'markets', 'models', 'correlations', 'engine'],
         'positional_defaults': {},
         'keyword_only': ['maximum_step', 'worker_threads', 'reduction_block_size', 'lsv_configs', 'driver_correlations', 'rate_model', 'rate_correlations', 'lsv_targets', 'local_correlation'],
         'required_keyword_only': ['maximum_step'],
         'keyword_only_defaults': {'worker_threads': 1, 'reduction_block_size': 4096, 'lsv_configs': None, 'driver_correlations': None, 'rate_model': None, 'rate_correlations': None, 'lsv_targets': None, 'local_correlation': None}},
        ('MultiAssetPlan', 'evaluate'): {'positional': ['self'],
         'positional_defaults': {},
         'keyword_only': [],
         'required_keyword_only': [],
         'keyword_only_defaults': {}},
        ('MultiAssetPlan', 'evaluate_aad'): {'positional': ['self'],
         'positional_defaults': {},
         'keyword_only': ['gamma_relative_bump'],
         'required_keyword_only': [],
         'keyword_only_defaults': {'gamma_relative_bump': None}},
        ...
        ("HullWhiteEquityPlan", "evaluate_aad"): {
            "positional": ["self"],
            "positional_defaults": {},
            "keyword_only": [],
            "required_keyword_only": [],
        ...
        ("PricingRequest", "__init__"): {
            ...
            "keyword_only": ["lsm"],
            "required_keyword_only": [],
            "keyword_only_defaults": {"lsm": None},
        },
        ("LsmConfig", "__init__"): {
            "positional": ["self", "training_engine"],
            "positional_defaults": {},
            "keyword_only": [
                "state_variables",
                "max_degree",
            ...
            "keyword_only_defaults": {
                ...
                "max_degree": 3,
                "max_basis_columns": 64,
                "max_total_exponents": 64,
                "itm_abs_tolerance": 0.0,
                "abs_rank_tolerance": 1.0e-14,
                "rel_rank_tolerance": 1.0e-12,
        ...
        ("RiskRequest", "__init__"): {
            ...
            "keyword_only_defaults": {
                ...
                "payoff_smoothing_half_width": None,
    ...
    expected_class_members = {
        ...
        'StochasticDividendPlan': {'evaluate_rough_aad', 'compile_rough_bergomi', 'compile_rough_bergomi_lsv', 'compile_bergomi_lsv', 'compile_bergomi_two_factor_lsv', 'evaluate_gamma', 'evaluate_lsv_gamma', 'evaluate_correlation_aad', 'evaluate_bergomi_aad', 'evaluate_aad', 'evaluate_local_variance_risk', 'evaluate_lsv_spot_risk', 'evaluate_lsv_market_risk', 'evaluate_lsv_dividend_model_risk', 'evaluate_lsv_bergomi_parameter_risk', 'evaluate_lsv_rough_bergomi_parameter_risk', 'evaluate_lsv_rough_bergomi_correlation_risk', 'evaluate_lsv_correlation_risk', 'evaluate_lsv_bergomi_two_factor_parameter_risk', 'evaluate_lsv_bergomi_two_factor_correlation_risk', 'evaluate_vega_kt', 'compile_bergomi', 'compile_bergomi_two_factor', 'scheme', 'evaluate', 'plan_fingerprint', 'time_nodes', 'compile_bs', 'risky_spot', 'random_factor_count', 'lsv_time_nodes', 'lsv_log_moneyness_nodes', 'lsv_squared_leverage', 'lsv_initial_residual_equity'},
        'StochasticDividendLocalVarianceRisk': {'price', 'time_nodes', 'log_moneyness_nodes', 'node_adjoints', 'standard_errors', 'method', 'coordinate', 'uncertainty_scope'},
        'StochasticDividendLsvSpotRisk': {'price', 'delta', 'delta_standard_error', 'method', 'coordinate', 'uncertainty_scope'},
        'StochasticDividendLsvMarketRisk': {'price', 'delta', 'delta_standard_error', 'cash_times', 'cash_mean_adjoints', 'cash_mean_standard_errors', 'discount_times', 'discount_log_df_adjoints', 'discount_log_df_standard_errors', 'discount_node_dv01', 'repo_spread_times', 'repo_spread_log_df_adjoints', 'repo_spread_log_df_standard_errors', 'repo_spread_node_dv01', 'method', 'coordinate', 'uncertainty_scope'},
        'StochasticDividendLsvDividendModelRisk': {'price', 'parameter_labels', 'derivatives', 'standard_errors', 'parameter_bumps', 'dividend_mean_reversion_derivative', 'equity_linkage_derivative', 'dividend_volatility_derivative', 'equity_dividend_correlation_derivative', 'method', 'coordinate', 'uncertainty_scope'},
        'StochasticDividendLsvRoughBergomiCorrelationRisk': {'price', 'parameter_labels', 'derivatives', 'standard_errors', 'correlation_bumps', 'equity_volatility_correlation_derivative', 'dividend_volatility_correlation_derivative', 'method', 'coordinate', 'uncertainty_scope'},
        'StochasticDividendLsvRoughBergomiRisk': {'price', 'parameter_labels', 'derivatives', 'standard_errors', 'parameter_bumps', 'hurst_derivative', 'vol_of_vol_derivative', 'method', 'coordinate', 'uncertainty_scope'},
        'StochasticDividendLsvBergomiRisk': {'price', 'parameter_labels', 'derivatives', 'standard_errors', 'parameter_bumps', 'mean_reversion_derivative', 'vol_of_vol_derivative', 'method', 'coordinate', 'uncertainty_scope'},
        'StochasticDividendLsvCorrelationRisk': {'price', 'parameter_labels', 'derivatives', 'standard_errors', 'correlation_bumps', 'equity_volatility_correlation_derivative', 'dividend_volatility_correlation_derivative', 'method', 'coordinate', 'uncertainty_scope'},
        'StochasticDividendLsvBergomi2FactorRisk': {'price', 'parameter_labels', 'derivatives', 'standard_errors', 'parameter_bumps', 'mean_reversion_derivatives', 'vol_of_vol_derivative', 'mixing_weight_derivative', 'method', 'coordinate', 'uncertainty_scope'},
        'StochasticDividendLsvBergomi2FactorCorrelationRisk': {'price', 'parameter_labels', 'derivatives', 'standard_errors', 'correlation_bumps', 'spot_volatility_correlation_derivatives', 'factor_correlation_derivative', 'dividend_volatility_correlation_derivatives', 'method', 'coordinate', 'uncertainty_scope'},
        ...
        'MultiAssetPlan': {'local_correlation_calibration', 'has_hull_white', 'hull_white_calibrations', 'random_factor_count', 'lsv_calibrations', 'lsv_driver_correlations', 'lsv_transition_covariances', 'evaluate_aad', 'correlation_entry_indices', 'compile', 'time_nodes', 'evaluate', 'fingerprint', 'underlying_ids'},
        ...
        'MultiAssetPrice': {'local_correlation_risk', 'hull_white_curve_risk', 'lsv_leverage_boundary_counts', 'local_variance_boundary_counts', 'price', 'scramble_checksum', 'value', 'standard_error', 'evaluated_paths', 'reduction_block_size', 'risks', 'gamma_relative_bump', 'worker_threads', 'fingerprint', 'gamma', 'direction_checksum', 'underlying_ids'},
        ...
        "HullWhiteAadRisk": {
            ...
            "discount_node_dv01",
            "parallel_discount_dv01",
            "time_nodes",
            "log_moneyness_nodes",
            "local_variance_adjoints",
        ...
        "Diagnostics": {
            ...
            "payoff_smoothing_policy_version",
            "payoff_smoothing_half_width",
            "payoff_smoothing_full_transition_width",
            "payoff_smoothing_width_unit",
            "payoff_smoothing_price_and_greeks_share_payoff",
            "payoff_smoothing_endpoint_count",
            "payoff_smoothing_dividend_jump_count",
            "path_state_kind",
            "asian_known_observation_count",
            "asian_unknown_observation_count",
            "asian_known_weight_sum",
            "asian_unknown_weight_sum",
            "asian_weighted_known_fixing_sum",
            "lookback_past_monitoring_count",
            "lookback_future_monitoring_count",
            "lookback_historical_extremum",
            "barrier_bridge_abi",
            "barrier_bridge_policy_version",
            "barrier_hit_indicator_mode",
            "barrier_endpoint_hit_fraction",
            "barrier_dividend_jump_hit_fraction",
            "barrier_mean_conditional_bridge_hit_weight",
            "barrier_mean_interval_count",
            "barrier_mean_finite_correction_count",
            "barrier_mean_zero_variance_count",
            "barrier_mean_survival_underflow_count",
            "barrier_mean_certain_survival_count",
            "delta_method",
            "gamma_method",
            "vega_method",
            "gamma_spot_bump",
        ...
        "EarlyExerciseDiagnostics": {
            "policy_fingerprint",
            "training_random_domain",
            "valuation_random_domain",
            "training_direction_checksum",
            "training_scramble_checksum",
            "valuation_direction_checksum",
            "valuation_scramble_checksum",
            "training_sampling_units",
            "training_trajectories",
            "valuation_sampling_units",
            "valuation_trajectories",
            "in_sample_value",
            "exercise_dates",
            "exercise_counts",
        ...
        "PricingPlan": {
            ...
            "worker_threads",
            "reduction_block_size",
            "request_original_schema_version",
            "request_current_schema_version",
            "request_migration_ids",
            "request_pre_migration_fingerprint",
            "request_post_migration_fingerprint",
        },
        "PricingRequest": {
            "__init__",
            "__repr__",
        ...
        "PricingResult": {
            ...
            "replay_platform",
            "replay_original_schema_version",
            "replay_current_schema_version",
            "replay_migration_ids",
            "replay_pre_migration_fingerprint",
            "replay_post_migration_fingerprint",
            "to_json",
            "to_pretty_json",
        },
        "PricingWarning": {
    ...
    expected_static_methods = {
        ...
        ("StochasticDividendPlan", "compile_rough_bergomi"),
        ("StochasticDividendPlan", "compile_bergomi_two_factor"),
        ("StochasticDividendPlan", "compile_bergomi_lsv"),
        ("StochasticDividendPlan", "compile_bergomi_two_factor_lsv"),
        ('HullWhiteEquityPlan', 'compile_bergomi'),
        ('HullWhiteEquityPlan', 'compile_bergomi_two_factor'),
        ('StochasticVolatilityPlan', 'compile_bergomi'),
        ('StochasticVolatilityPlan', 'compile_bergomi_two_factor'),
    ...
    expected_properties = {
        ('StochasticDividendHullWhitePlan', 'plan_fingerprint'),
        ('StochasticDividendHullWhitePlan', 'scheme'),
        ('StochasticDividendHullWhitePlan', 'time_nodes'),
        ('StochasticDividendHullWhitePlan', 'random_factor_count'),
        ('StochasticDividendHullWhitePlan', 'risky_spot'),
        ('StochasticDividendHullWhitePlan', 'cash_times'),
        ('StochasticDividendHullWhitePlan', 'initial_dividend_claim_values'),
        ('StochasticDividendHullWhitePlan', 'initial_dividend_forwards'),
        ...
        ('StochasticDividendPlan', 'lsv_time_nodes'),
        ('StochasticDividendPlan', 'lsv_log_moneyness_nodes'),
        ('StochasticDividendPlan', 'lsv_squared_leverage'),
        ('StochasticDividendPlan', 'lsv_initial_residual_equity'),
        ('StochasticDividendGammaRisk', 'price'),
        ('StochasticDividendGammaRisk', 'delta'),
        ('StochasticDividendGammaRisk', 'delta_standard_error'),
        ('StochasticDividendGammaRisk', 'spot'),
        ('StochasticDividendGammaRisk', 'spot_bumps'),
        ('StochasticDividendGammaRisk', 'gamma'),
        ('StochasticDividendGammaRisk', 'standard_error'),
        ('StochasticDividendGammaRisk', 'gamma_estimates'),
        ('StochasticDividendGammaRisk', 'gamma_standard_errors'),
        ('StochasticDividendGammaRisk', 'bump_differences'),
        ('StochasticDividendGammaRisk', 'bump_difference_standard_errors'),
        ('StochasticDividendGammaRisk', 'payoff_evaluations'),
        ('StochasticDividendGammaRisk', 'risk_fingerprint'),
        ('StochasticDividendGammaRisk', 'method'),
        ('StochasticDividendGammaRisk', 'delta_change_per_one_percent_spot'),
        ('StochasticDividendGammaRisk', 'uncertainty_scope'),
        ...
        ('MultiAssetPlan', 'local_correlation_calibration'),
        ('MultiAssetPrice', 'local_correlation_risk'),
        ('LocalCorrelationConfig', 'basket_weights'),
        ('LocalCorrelationConfig', 'target_model'),
        ('LocalCorrelationConfig', 'second_correlations'),
        ('LocalCorrelationConfig', 'particle_count'),
        ('LocalCorrelationConfig', 'calibration_seed'),
        ('LocalCorrelationConfig', 'log_bandwidth'),
        ('LocalCorrelationConfig', 'minimum_effective_samples'),
        ...
        ('LocalCorrelationCalibration', 'endpoint_variances'),
        ('LocalCorrelationCalibration', 'target_variances'),
        ('LocalCorrelationCalibration', 'attained_variances'),
        ('LocalCorrelationCalibration', 'variance_residuals'),
        ('LocalCorrelationCalibration', 'raw_mixing'),
        ('LocalCorrelationCalibration', 'effective_samples'),
        ('LocalCorrelationCalibration', 'source_nodes'),
        ('LocalCorrelationCalibration', 'fallback_nodes'),
        ('LocalCorrelationCalibration', 'projected_nodes'),
        ...
        ('LocalCorrelationRisk', 'basket_standard_errors'),
        ('LocalCorrelationRisk', 'asset_adjoints'),
        ('LocalCorrelationRisk', 'asset_standard_errors'),
        ...
        ('CorrelationSchedule', 'raw_matrices'),
        ('CorrelationSchedule', 'lower_factors'),
        ('CorrelationSchedule', 'ranks'),
        ('CorrelationSchedule', 'pivots'),
        ('CorrelationSchedule', 'zero_pivots'),
        ('CorrelationSchedule', 'maximum_adjustments'),
        ('MultiAssetProduct', 'underlying_ids'),
        ('MultiAssetPlan', 'fingerprint'),
        ('MultiAssetPlan', 'time_nodes'),
        ('MultiAssetPlan', 'correlation_entry_indices'),
        ('MultiAssetPlan', 'underlying_ids'),
        ('MultiAssetRisk', 'underlying_id'),
        ('MultiAssetRisk', 'delta'),
        ('MultiAssetRisk', 'delta_per_one_percent_spot'),
        ('MultiAssetRisk', 'bs_vega'),
        ('MultiAssetRisk', 'bs_vega_per_vol_point'),
        ('MultiAssetRisk', 'local_variance'),
        ('MultiAssetRisk', 'local_variance_time_nodes'),
        ('MultiAssetRisk', 'local_variance_log_moneyness_nodes'),
        ('MultiAssetPrice', 'value'),
        ('MultiAssetPrice', 'standard_error'),
        ('MultiAssetPrice', 'price'),
        ('MultiAssetPrice', 'risks'),
        ('MultiAssetPrice', 'gamma'),
        ('MultiAssetPrice', 'gamma_relative_bump'),
        ('MultiAssetPrice', 'underlying_ids'),
        ('MultiAssetPrice', 'fingerprint'),
        ('MultiAssetPrice', 'evaluated_paths'),
        ('MultiAssetPrice', 'worker_threads'),
        ('MultiAssetPrice', 'reduction_block_size'),
        ('MultiAssetPrice', 'local_variance_boundary_counts'),
        ('MultiAssetPrice', 'direction_checksum'),
        ('MultiAssetPrice', 'scramble_checksum'),
        ...
        ("HullWhiteAadRisk", "standard_errors"),
        ("HullWhiteAadRisk", "delta"),
        ("HullWhiteAadRisk", "vega"),
        ("HullWhiteAadRisk", "discount_times"),
        ("HullWhiteAadRisk", "dividend_times"),
        ("HullWhiteAadRisk", "discount_log_df_adjoints"),
        ("HullWhiteAadRisk", "dividend_log_df_adjoints"),
        ("HullWhiteAadRisk", "discount_node_dv01"),
        ("HullWhiteAadRisk", "parallel_discount_dv01"),
        ("HullWhiteAadRisk", "time_nodes"),
        ("HullWhiteAadRisk", "log_moneyness_nodes"),
        ("HullWhiteAadRisk", "local_variance_adjoints"),
        ("HullWhiteAadRisk", "forward_log_density_adjoints"),
        ("HullWhiteAadRisk", "method"),
        ("HullWhiteAadRisk", "uncertainty_scope"),
        ...
        ("Bergomi2FactorLsvPlan", "plan_fingerprint"),
        ("RoughBergomiLsvPlan", "plan_fingerprint"),
        ("BergomiLsvPlan", "time_nodes"),
        ("Bergomi2FactorLsvPlan", "time_nodes"),
        ("RoughBergomiLsvPlan", "time_nodes"),
        ("BergomiLsvPlan", "log_moneyness_nodes"),
        ("Bergomi2FactorLsvPlan", "log_moneyness_nodes"),
        ("RoughBergomiLsvPlan", "log_moneyness_nodes"),
        ("BergomiLsvPlan", "squared_leverage"),
        ("Bergomi2FactorLsvPlan", "squared_leverage"),
        ("RoughBergomiLsvPlan", "squared_leverage"),
        ("BergomiLsvPlan", "extrapolated_moment_nodes"),
        ("Bergomi2FactorLsvPlan", "extrapolated_moment_nodes"),
        ("RoughBergomiLsvPlan", "extrapolated_moment_nodes"),
        ("BergomiLsvPlan", "minimum_effective_samples"),
        ("Bergomi2FactorLsvPlan", "minimum_effective_samples"),
        ("RoughBergomiLsvPlan", "minimum_effective_samples"),
        ...
        ("StochasticDividendLocalVarianceRisk", "price"),
        ("StochasticDividendLocalVarianceRisk", "time_nodes"),
        ("StochasticDividendLocalVarianceRisk", "log_moneyness_nodes"),
        ("StochasticDividendLocalVarianceRisk", "node_adjoints"),
        ("StochasticDividendLocalVarianceRisk", "standard_errors"),
        ("StochasticDividendLocalVarianceRisk", "method"),
        ("StochasticDividendLocalVarianceRisk", "coordinate"),
        ("StochasticDividendLocalVarianceRisk", "uncertainty_scope"),
        ("StochasticDividendLsvSpotRisk", "price"),
        ("StochasticDividendLsvSpotRisk", "delta"),
        ("StochasticDividendLsvSpotRisk", "delta_standard_error"),
        ("StochasticDividendLsvSpotRisk", "method"),
        ("StochasticDividendLsvSpotRisk", "coordinate"),
        ("StochasticDividendLsvSpotRisk", "uncertainty_scope"),
        ("StochasticDividendLsvMarketRisk", "price"),
        ("StochasticDividendLsvMarketRisk", "delta"),
        ("StochasticDividendLsvMarketRisk", "delta_standard_error"),
        ("StochasticDividendLsvMarketRisk", "cash_times"),
        ("StochasticDividendLsvMarketRisk", "cash_mean_adjoints"),
        ("StochasticDividendLsvMarketRisk", "cash_mean_standard_errors"),
        ("StochasticDividendLsvMarketRisk", "discount_times"),
        ("StochasticDividendLsvMarketRisk", "discount_log_df_adjoints"),
        ("StochasticDividendLsvMarketRisk", "discount_log_df_standard_errors"),
        ("StochasticDividendLsvMarketRisk", "discount_node_dv01"),
        ("StochasticDividendLsvMarketRisk", "repo_spread_times"),
        ("StochasticDividendLsvMarketRisk", "repo_spread_log_df_adjoints"),
        ("StochasticDividendLsvMarketRisk", "repo_spread_log_df_standard_errors"),
        ("StochasticDividendLsvMarketRisk", "repo_spread_node_dv01"),
        ("StochasticDividendLsvMarketRisk", "method"),
        ("StochasticDividendLsvMarketRisk", "coordinate"),
        ("StochasticDividendLsvMarketRisk", "uncertainty_scope"),
        ("StochasticDividendLsvDividendModelRisk", "price"),
        ("StochasticDividendLsvDividendModelRisk", "parameter_labels"),
        ("StochasticDividendLsvDividendModelRisk", "derivatives"),
        ("StochasticDividendLsvDividendModelRisk", "standard_errors"),
        ("StochasticDividendLsvDividendModelRisk", "parameter_bumps"),
        ("StochasticDividendLsvDividendModelRisk", "dividend_mean_reversion_derivative"),
        ("StochasticDividendLsvDividendModelRisk", "equity_linkage_derivative"),
        ("StochasticDividendLsvDividendModelRisk", "dividend_volatility_derivative"),
        ("StochasticDividendLsvDividendModelRisk", "equity_dividend_correlation_derivative"),
        ("StochasticDividendLsvDividendModelRisk", "method"),
        ("StochasticDividendLsvDividendModelRisk", "coordinate"),
        ("StochasticDividendLsvDividendModelRisk", "uncertainty_scope"),
        ("StochasticDividendLsvBergomiRisk", "price"),
        ("StochasticDividendLsvBergomiRisk", "parameter_labels"),
        ("StochasticDividendLsvBergomiRisk", "derivatives"),
        ("StochasticDividendLsvBergomiRisk", "standard_errors"),
        ("StochasticDividendLsvBergomiRisk", "parameter_bumps"),
        ("StochasticDividendLsvBergomiRisk", "mean_reversion_derivative"),
        ("StochasticDividendLsvBergomiRisk", "vol_of_vol_derivative"),
        ("StochasticDividendLsvBergomiRisk", "method"),
        ("StochasticDividendLsvBergomiRisk", "coordinate"),
        ("StochasticDividendLsvBergomiRisk", "uncertainty_scope"),
        ("StochasticDividendLsvCorrelationRisk", "price"),
        ("StochasticDividendLsvCorrelationRisk", "parameter_labels"),
        ("StochasticDividendLsvCorrelationRisk", "derivatives"),
        ("StochasticDividendLsvCorrelationRisk", "standard_errors"),
        ("StochasticDividendLsvCorrelationRisk", "correlation_bumps"),
        ("StochasticDividendLsvCorrelationRisk", "equity_volatility_correlation_derivative"),
        ("StochasticDividendLsvCorrelationRisk", "dividend_volatility_correlation_derivative"),
        ("StochasticDividendLsvCorrelationRisk", "method"),
        ("StochasticDividendLsvCorrelationRisk", "coordinate"),
        ("StochasticDividendLsvCorrelationRisk", "uncertainty_scope"),
        ("StochasticDividendLsvBergomi2FactorRisk", "price"),
        ("StochasticDividendLsvBergomi2FactorRisk", "parameter_labels"),
        ("StochasticDividendLsvBergomi2FactorRisk", "derivatives"),
        ("StochasticDividendLsvBergomi2FactorRisk", "standard_errors"),
        ("StochasticDividendLsvBergomi2FactorRisk", "parameter_bumps"),
        ("StochasticDividendLsvBergomi2FactorRisk", "mean_reversion_derivatives"),
        ("StochasticDividendLsvBergomi2FactorRisk", "vol_of_vol_derivative"),
        ("StochasticDividendLsvBergomi2FactorRisk", "mixing_weight_derivative"),
        ("StochasticDividendLsvBergomi2FactorRisk", "method"),
        ("StochasticDividendLsvBergomi2FactorRisk", "coordinate"),
        ("StochasticDividendLsvBergomi2FactorRisk", "uncertainty_scope"),
        ("StochasticDividendLsvBergomi2FactorCorrelationRisk", "price"),
        ("StochasticDividendLsvBergomi2FactorCorrelationRisk", "parameter_labels"),
        ("StochasticDividendLsvBergomi2FactorCorrelationRisk", "derivatives"),
        ("StochasticDividendLsvBergomi2FactorCorrelationRisk", "standard_errors"),
        ("StochasticDividendLsvBergomi2FactorCorrelationRisk", "correlation_bumps"),
        ("StochasticDividendLsvBergomi2FactorCorrelationRisk", "spot_volatility_correlation_derivatives"),
        ("StochasticDividendLsvBergomi2FactorCorrelationRisk", "factor_correlation_derivative"),
        ("StochasticDividendLsvBergomi2FactorCorrelationRisk", "dividend_volatility_correlation_derivatives"),
        ("StochasticDividendLsvBergomi2FactorCorrelationRisk", "method"),
        ("StochasticDividendLsvBergomi2FactorCorrelationRisk", "coordinate"),
        ("StochasticDividendLsvBergomi2FactorCorrelationRisk", "uncertainty_scope"),
        ("LsvPrice", "value"),
        ...
        ("Diagnostics", "barrier_bridge_policy_version"),
        ("Diagnostics", "barrier_dividend_jump_hit_fraction"),
        ("Diagnostics", "barrier_endpoint_hit_fraction"),
        ("Diagnostics", "barrier_hit_indicator_mode"),
        ("Diagnostics", "barrier_mean_conditional_bridge_hit_weight"),
        ("Diagnostics", "barrier_mean_certain_survival_count"),
        ("Diagnostics", "barrier_mean_finite_correction_count"),
        ("Diagnostics", "barrier_mean_interval_count"),
        ("Diagnostics", "barrier_mean_survival_underflow_count"),
        ("Diagnostics", "barrier_mean_zero_variance_count"),
        ("Diagnostics", "bump_policy_version"),
        ("Diagnostics", "exercise_strategy_risk"),
        ("Diagnostics", "stopping_index_risk"),
        ("Diagnostics", "exercise_policy_fingerprint"),
        ...
        ("Diagnostics", "valuation_kind"),
        ("Diagnostics", "payoff_smoothing_full_transition_width"),
        ("Diagnostics", "payoff_smoothing_width_unit"),
        ("Diagnostics", "payoff_smoothing_price_and_greeks_share_payoff"),
        ("Diagnostics", "path_state_kind"),
        ("Diagnostics", "asian_known_observation_count"),
        ("Diagnostics", "asian_unknown_observation_count"),
        ("Diagnostics", "asian_known_weight_sum"),
        ("Diagnostics", "asian_unknown_weight_sum"),
        ("Diagnostics", "asian_weighted_known_fixing_sum"),
        ("Diagnostics", "lookback_past_monitoring_count"),
        ("Diagnostics", "lookback_future_monitoring_count"),
        ("Diagnostics", "lookback_historical_extremum"),
        ("Diagnostics", "payoff_fingerprint"),
        ("Diagnostics", "payoff_smoothing_half_width"),
        ("Diagnostics", "payoff_smoothing_dividend_jump_count"),
        ("Diagnostics", "payoff_smoothing_endpoint_count"),
        ("Diagnostics", "payoff_smoothing_kernel"),
        ("Diagnostics", "payoff_smoothing_policy_version"),
        ...
        ("LsmWarning", "kind"),
        ("LsmWarning", "index"),
        ("LsmFeatureScaling", "mean"),
        ("LsmFeatureScaling", "population_variance"),
        ("LsmFeatureScaling", "scale"),
        ("LsmFeatureScaling", "zero_scale_threshold"),
        ("LsmFeatureScaling", "inactive"),
        ("ExerciseDecisionDiagnostics", "kind"),
        ("ExerciseDecisionDiagnostics", "continue_all_reason"),
        ("ExerciseDecisionDiagnostics", "feature_scalings"),
        ("ExerciseDecisionDiagnostics", "active_basis_columns"),
        ("ExerciseDecisionDiagnostics", "pre_excluded_basis_columns"),
        ("ExerciseDecisionDiagnostics", "pivot_order"),
        ("ExerciseDecisionDiagnostics", "diagonal_abs"),
        ("ExerciseDecisionDiagnostics", "rank_threshold"),
        ("ExerciseDecisionDiagnostics", "rank"),
        ("ExerciseDecisionDiagnostics", "rank_excluded_basis_columns"),
        ("ExerciseDecisionDiagnostics", "coefficients"),
        ("ExerciseDecisionDiagnostics", "residual_sum_squares"),
        ("ExerciseRegressionDiagnostics", "candidate_rows"),
        ("ExerciseRegressionDiagnostics", "itm_rows"),
        ("ExerciseRegressionDiagnostics", "feature_count"),
        ("ExerciseRegressionDiagnostics", "warnings"),
        ("EarlyExerciseDiagnostics", "policy_fingerprint"),
        ("EarlyExerciseDiagnostics", "training_random_domain"),
        ("EarlyExerciseDiagnostics", "valuation_random_domain"),
        ("EarlyExerciseDiagnostics", "training_direction_checksum"),
        ("EarlyExerciseDiagnostics", "training_scramble_checksum"),
        ("EarlyExerciseDiagnostics", "valuation_direction_checksum"),
        ("EarlyExerciseDiagnostics", "valuation_scramble_checksum"),
        ("EarlyExerciseDiagnostics", "training_sampling_units"),
        ("EarlyExerciseDiagnostics", "training_trajectories"),
        ("EarlyExerciseDiagnostics", "valuation_sampling_units"),
        ("EarlyExerciseDiagnostics", "valuation_trajectories"),
        ("EarlyExerciseDiagnostics", "in_sample_value"),
        ("EarlyExerciseDiagnostics", "exercise_dates"),
        ("EarlyExerciseDiagnostics", "exercise_counts"),
        ("EarlyExerciseDiagnostics", "exercise_probabilities"),
        ("EarlyExerciseDiagnostics", "stopping_indices"),
        ("EarlyExerciseDiagnostics", "dividend_collisions"),
        ("EarlyExerciseDiagnostics", "basis_feature_count"),
        ("EarlyExerciseDiagnostics", "basis_max_degree"),
        ("EarlyExerciseDiagnostics", "basis_exponents"),
        ("EarlyExerciseDiagnostics", "itm_abs_tolerance"),
        ("EarlyExerciseDiagnostics", "abs_rank_tolerance"),
        ("EarlyExerciseDiagnostics", "rel_rank_tolerance"),
        ("EarlyExerciseDiagnostics", "max_matrix_elements"),
        ("EarlyExerciseDiagnostics", "decisions"),
        ("EarlyExerciseDiagnostics", "regressions"),
        ("LsmConfig", "state_variables"),
        ("LsmConfig", "max_degree"),
        ("LsmConfig", "basis_exponents"),
        ("LsmConfig", "itm_abs_tolerance"),
        ("LsmConfig", "abs_rank_tolerance"),
        ("LsmConfig", "rel_rank_tolerance"),
        ("LsmConfig", "max_matrix_elements"),
        ("LsmConfig", "fingerprint"),
        ("PricingPlan", "plan_fingerprint"),
        ("PricingPlan", "reduction_block_size"),
        ("PricingPlan", "request_fingerprint"),
        ("PricingPlan", "request_original_schema_version"),
        ("PricingPlan", "request_current_schema_version"),
        ("PricingPlan", "request_migration_ids"),
        ("PricingPlan", "request_pre_migration_fingerprint"),
        ("PricingPlan", "request_post_migration_fingerprint"),
        ...
        ("PricingResult", "early_exercise_diagnostics"),
        ...
        ("PricingResult", "replay_original_schema_version"),
        ("PricingResult", "replay_current_schema_version"),
        ("PricingResult", "replay_migration_ids"),
        ("PricingResult", "replay_pre_migration_fingerprint"),
        ("PricingResult", "replay_post_migration_fingerprint"),
        ...
        ("WidthLadderDifference", "delta"),
        ("WidthLadderDifference", "gamma"),
        ("WidthLadderDifference", "price"),
        ("WidthLadderDifference", "vega"),
        ("WidthLadderEntry", "adjacent_difference"),
        ("WidthLadderEntry", "half_width"),
        ("WidthLadderEntry", "result"),
