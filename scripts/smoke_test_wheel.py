...
def verify_stub_static_shape(tree: ast.Module) -> None:
    ...
    expected_class_members = {
        ...
        'StochasticDividendPlan': {'evaluate_gamma', 'evaluate_correlation_aad', 'evaluate_bergomi_aad', 'evaluate_aad', 'compile_bergomi', 'compile_bergomi_two_factor', 'scheme', 'evaluate', 'plan_fingerprint', 'time_nodes', 'compile_bs', 'risky_spot', 'random_factor_count'},
