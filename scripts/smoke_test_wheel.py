...
def verify_stub_static_shape(tree: ast.Module) -> None:
    ...
    expected_class_members = {
        "StochasticDividendHullWhitePlan": {'evaluate_correlation_aad', 'evaluate_aad', 'evaluate_hull_white_aad', 'random_factor_count', 'time_nodes', 'plan_fingerprint', 'initial_dividend_claim_values', 'cash_times', 'compile_bs', 'evaluate', 'scheme', 'initial_dividend_forwards', 'risky_spot'},
        ...
        'StochasticDividendPlan': {'evaluate_rough_aad', 'compile_rough_bergomi', 'evaluate_gamma', 'evaluate_correlation_aad', 'evaluate_bergomi_aad', 'evaluate_aad', 'compile_bergomi', 'compile_bergomi_two_factor', 'scheme', 'evaluate', 'plan_fingerprint', 'time_nodes', 'compile_bs', 'risky_spot', 'random_factor_count'},
