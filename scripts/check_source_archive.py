...
REQUIRED_FILES = {
    ...
    'crates/pricing/src/engine/risk/stochastic_dividends/hull_white/gamma.rs',
    'crates/pricing/tests/stochastic_dividend_hull_white_gamma.rs',
    'tests/python/test_stochastic_dividend_hull_white_gamma.py',
    'design/adr/0026-stochastic-dividend-hull-white-gamma.md',
    'design/validation/stochastic-dividend-hull-white-gamma.md',
    'crates/pricing/tests/stochastic_dividend_hull_white_risk.rs',
    'tests/python/test_stochastic_dividend_hull_white_risk.py',
    'examples/python/stochastic_dividend_hull_white_risk.py',
    'design/adr/0023-stochastic-dividend-hull-white-risk.md',
    'design/validation/stochastic-dividend-hull-white-risk.md',
    'design/adr/0024-stochastic-dividend-hull-white-parameter-risk.md',
    'design/validation/stochastic-dividend-hull-white-parameter-risk.md',
    ...
    'examples/python/rough_dividend_correlation_risk.py',
    'design/adr/0021-rough-stochastic-dividend-correlation-risk.md',
    'design/validation/rough-stochastic-dividend-correlation-risk.md',
    ...
    'tests/python/rough_dividend_reference.py',
    'examples/python/rough_dividends.py',
    'design/adr/0019-rough-stochastic-dividends.md',
    'design/validation/rough-stochastic-dividends.md',

    'crates/pricing/src/engine/risk/stochastic_dividends/gamma.rs',
    'crates/pricing/tests/stochastic_dividend_gamma.rs',
    'tests/python/test_stochastic_dividend_gamma.py',
    'examples/python/stochastic_dividend_gamma.py',
    'design/adr/0018-stochastic-dividend-gamma.md',
    'design/validation/stochastic-dividend-gamma.md',
    "crates/pricing/src/engine/processes/stochastic_dividends/bergomi/correlation_reverse.rs",
    "crates/pricing/tests/stochastic_dividend_correlation_risk.rs",
    "tests/python/test_stochastic_dividend_correlation_risk.py",
    "examples/python/stochastic_dividend_correlation_risk.py",
    "design/adr/0017-stochastic-dividend-correlation-risk.md",
    "design/validation/stochastic-dividend-correlation-risk.md",
    "crates/pricing/src/engine/processes/stochastic_dividends/bergomi/parameter_reverse.rs",
    "crates/pricing/tests/stochastic_dividend_bergomi_risk.rs",
    "tests/python/test_stochastic_dividend_bergomi_risk.py",
    "examples/python/stochastic_dividend_bergomi_risk.py",
    "design/adr/0016-stochastic-dividend-bergomi-risk.md",
    "design/validation/stochastic-dividend-bergomi-risk.md",
    ...
    "scripts/test_profile_model_heap_followup.py",
    "design/validation/local-correlation-heap-followup.md",
    "docs/README.md",
    "docs/library/README.md",
    "docs/models/README.md",
    "docs/models/hull-white-cash-dividends.md",
    "design/adr/0009-escrowed-simulation-and-iv-conversion.md",
    "design/adr/0010-remove-paid-cash.md",
    "design/validation/escrowed-dividends.md",
    "design/validation/escrowed-dividends-observations.json",
    "crates/pricing/tests/hull_white_escrowed_default.rs",
    "design/README.md",
    ...
    "crates/pricing/tests/extended_risk_acceptance.rs",
    "crates/pricing/tests/cases/extended_risk_single.rs",
    "crates/pricing/tests/cases/extended_risk_multi.rs",
    ...
    "design/validation/extended-model-risk-accuracy.md",
    "design/validation/extended-model-risk-observations.json",
...
REQUIRED_WHEEL_SMOKE_SNIPPETS = {
    ...
    "workspace_dependency_purl_matches(purl, name, version)",
