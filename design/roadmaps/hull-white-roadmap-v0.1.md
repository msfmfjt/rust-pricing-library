...
rough-LSV/HW local-correlation case. The subsequent
[refinement and stress record](../validation/extended-model-refinement-stress.md)
adds particle, step and bandwidth studies for all three HW/LSV factors and
joint local correlation, plus 3-year wing/high-vol-of-vol cases. These strengthen
H2/H3 price evidence without closing the broader risk and production gates above.
