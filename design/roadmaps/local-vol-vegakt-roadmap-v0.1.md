...
Status: Accepted
Date: 2026-09-08
Requirements baseline: [requirements-v1.0.md](../requirements-v1.0.md) (Frozen)
Architecture baseline: [architecture-v0.1.md](../architecture-v0.1.md)
Predecessor: [european-bs-conformance-v0.1.md](../validation/european-bs-conformance-v0.1.md) (Accepted)
