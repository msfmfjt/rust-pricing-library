...
- [Public API inventory](three-crate/public-api.json): 377 original
  ...
  [migration guide](../../docs/library/three-crate-migration.md); that part is breaking.
- [Test mapping](three-crate/test-moves.json): all 430 old Rust tests
...
- [Mechanical audit](three-crate/mechanical-audit.json): 2,716 of 2,717
...
- [Contract hashes](three-crate/unchanged-contract-hashes.json): all
...
[Replay hashes and byte counts](three-crate/replay-comparison.json)
...
[comparison.json](three-crate/comparison.json).
...
Both sets are preserved in [lsm-confirmation.json](three-crate/lsm-confirmation.json)
...
[baseline commands](three-crate/baseline-commands.json),
[corrected baseline commands](three-crate/baseline-corrected-commands.json),
[migration commands](three-crate/after-commands.json),
[final corrected gates](three-crate/final-structure-commands.json),
[exact CI acceptance commands](three-crate/ci-acceptance.json),
[baseline targets/features](three-crate/baseline-targets.json),
[migrated targets/features](three-crate/after-targets.json),
[boundary probes](three-crate/boundary-probes.json), and
[frozen replay attempts](three-crate/frozen-replay-checks.json).

[run-artifacts.tar.gz](three-crate/run-artifacts.tar.gz) contains the
