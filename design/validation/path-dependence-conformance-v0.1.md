...
Requirements: [requirements-v1.0.md](../requirements-v1.0.md)

Roadmap: [path-dependence-roadmap-v0.1.md](../roadmaps/path-dependence-roadmap-v0.1.md)
...
|---|---|---|
| P0 | [path-dependence-numerical-contracts-v0.1.md](../../docs/library/path-dependence-numerical-contracts-v0.1.md), Decimal reference fixture, independent checker | Satisfied locally |
...
- numerical policy: [path-dependence-numerical-contracts-v0.1.md](../../docs/library/path-dependence-numerical-contracts-v0.1.md);
- diagnostics catalogue: [path-dependence-diagnostics-v0.1.md](../../docs/library/path-dependence-diagnostics-v0.1.md);
