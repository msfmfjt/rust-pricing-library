...
| Gates | H0–H3 in the [roadmap](../roadmaps/hull-white-roadmap-v0.1.md); broad refinement, hybrid AAD, stable wire support and benchmark acceptance remain open |
...
[calculation specifications](../../docs/models/hull-white-calculation-specifications.md) for the model,
