...
[local-vol-vegakt-numerical-contracts-v0.1.md](../docs/models/local-vol-vegakt-numerical-contracts-v0.1.md). These policies remain
...
[local-vol-vegakt-conformance-v0.1.md](validation/local-vol-vegakt-conformance-v0.1.md).
...
[european-bs-roadmap-v0.1.md](roadmaps/european-bs-roadmap-v0.1.md). The Local Volatility/VegaKT stage is committed
through [local-vol-vegakt-roadmap-v0.1.md](roadmaps/local-vol-vegakt-roadmap-v0.1.md) and accepted in
[local-vol-vegakt-conformance-v0.1.md](validation/local-vol-vegakt-conformance-v0.1.md). Later stages remain sequencing
...
[local-vol-vegakt-numerical-contracts-v0.1.md](../docs/models/local-vol-vegakt-numerical-contracts-v0.1.md), and the conformance reports.
